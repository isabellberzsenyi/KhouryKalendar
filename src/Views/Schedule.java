...
//    MONDAY
    JButton[] mondayButtons = {makeTimeButton("1pm - 3pm", "Kariotis 011", "QUEUE: 24", true),
            makeTimeButton("4pm - 7pm", "Hastings 024", "", false)};
    JPanel monday = makeTimePanel("Monday Jan 6", mondayButtons);
    schedule.add(monday);
//    TUESDAY
    JButton[] tuesButtons = {makeTimeButton("1pm - 3pm", "Kariotis 011", "QUEUE: 24", false),
            makeTimeButton("4pm - 7pm", "Hastings 024", "", false)};
    JPanel tuesday = makeTimePanel("Tuesday Jan 7", tuesButtons);
    schedule.add(tuesday);
//    WEDNESDAY
    JButton[] wedButtons = {makeTimeButton("1pm - 3pm", "Kariotis 011", "QUEUE: 24", false),
            makeTimeButton("4pm - 7pm", "Hastings 024", "", false)};
    JPanel wednesday = makeTimePanel("Wednesday Jan 8", wedButtons);
    schedule.add(wednesday);
//    THURSDAY
    JButton[] thursButtons = {makeTimeButton("1pm - 3pm", "Kariotis 011", "QUEUE: 24", false),
            makeTimeButton("4pm - 7pm", "Hastings 024", "", false)};
    JPanel thurs = makeTimePanel("Thursday Jan 9", thursButtons);
    schedule.add(thurs);
//    FRIDAY
    JButton[] friButtons = {makeTimeButton("1pm - 3pm", "Kariotis 011", "QUEUE: 24", false),
            makeTimeButton("4pm - 7pm", "Hastings 024", "", false)};
  ...
  JButton makeTimeButton(String top, String middle, String  bottom, boolean active) {
